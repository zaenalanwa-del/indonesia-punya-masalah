...
{id:'jalan-purworejo',title:'Jalan Provinsi di Purworejo Rusak Parah, Warga Resah',category:'Infrastruktur',status:'Mendesak',region_name:'Purworejo, Jawa Tengah',reported_at:'2 jam yang lalu',description:'Laporan kondisi jalan yang dikeluhkan warga. Data lapangan tetap perlu diverifikasi sebelum dinyatakan sebagai fakta terverifikasi.',media_urls:['/assets/problem-road.svg'],source:'Ilustrasi kategori lokal',is_demo:true},
{id:'banjir-demak',title:'Banjir di Demak Rendam 5 Desa, Ratusan Warga Mengungsi',category:'Bencana Alam',status:'Terkini',region_name:'Demak, Jawa Tengah',reported_at:'4 jam yang lalu',description:'Laporan mengenai banjir yang berdampak pada permukiman warga. Jumlah terdampak dan kondisi terkini harus dicocokkan dengan sumber resmi.',media_urls:['/assets/problem-flood.svg'],source:'Ilustrasi kategori lokal',is_demo:true},
